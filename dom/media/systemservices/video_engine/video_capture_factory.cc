...
auto VideoCaptureFactory::InitCameraBackend()
  ...
  if (!mPromise) {
    ...
    mPromise = mPromise->Then(
        GetCurrentSerialEventTarget(), "VideoCaptureFactory::InitCameraBackend",
        [this, self = RefPtr(this)](
          ...
          if (aValue.IsResolve()) {
            ...
            return CameraBackendInitPromise::CreateAndReject(
                aValue.RejectValue(),
                "VideoCaptureFactory::InitCameraBackend Reject");
          }
        });
  }
